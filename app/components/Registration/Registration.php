...
class Registration extends BaseComponent
{
	...
	public function imageFormSubmitted(Form $form)
	{
		...
		$this->getPresenter()->flashMessage('Děkujeme, že ses přihlásil(a) na K-SCUK. Brzy ti pošleme e-mail s dalšími instrukcemi.', 'success');
	...
	private function buildQuestionForm($name, $category)
	{
		...
		if ($this->nextCategory($category) !== NULL) {
