<?php //netteCache[01]000238a:2:{s:4:"time";s:21:"0.48809700 1366547232";s:9:"callbacks";a:1:{i:0;a:3:{i:0;a:2:{i:0;s:5:"Cache";i:1;s:9:"checkFile";}i:1;s:83:"/home/jan/Projekty/fi.muni.cz/K-SCUK/web/www/../app/templates/Forms/../layout.phtml";i:2;i:1366545466;}}}?><?php
// file …/templates/Forms/../layout.phtml
//

$_cb = LatteMacros::initRuntime($template, NULL, 'f5af75e32c'); unset($_extends);


//
// block header
//
if (!function_exists($_cb->blocks['header'][] = '_cbb3ccb9ede2a_header')) { function _cbb3ccb9ede2a_header($_args) { extract($_args)
;
}}
...
// block body
//
if (!function_exists($_cb->blocks['body'][] = '_cbbbe5314eae7_body')) { function _cbbbe5314eae7_body($_args) { extract($_args)
;
}}
